...
- **Pimpl (Handle/Body)**: using a pointer to an incomplete type to hide implementation details. Before C++11, this required a raw pointer and manual copy/move operations.
